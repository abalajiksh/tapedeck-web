...
export const CAVEATS = [
  ...
  { title: "The richer MusicBrainz ids aren't stored yet", body: "A tagging client is the only thing that ever knows the release-group, release-track, work and album-artist ids of what was played \u2014 fooyin's Tapeout plugin sends all four, and until the columns land they are accepted and dropped. The work id is the one classical needs, since a single work spans dozens of recordings and nothing else relates them. Being added now." },
  ...
  { title: "The genre space is per-artist, for now", body: "Every Noise at Once places artists, so every track by one artist shares its six sound coordinates \u2014 the Genre Map and Playlist Lab are a placeholder until the analysis plugin computes per-recording features from your real files." },
